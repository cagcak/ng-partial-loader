...
class NgPartialLoaderDirective {
    ...
    get utils() {
        ...
        return {
            options: Object.assign(Object.assign({}, defaults), (options && Object.assign({}, options))),
            loader() {
    ...
    ngOnInit() {
        ...
        if ((_a = this.utils.options) === null || _a === void 0 ? void 0 : _a.fallback) {
    ...
    ngOnChanges(simpleChanges) {
        var _a;
        if (!((_a = simpleChanges['ngPartialLoader']) === null || _a === void 0 ? void 0 : _a.firstChange)) {
